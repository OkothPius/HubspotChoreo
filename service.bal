...
service / on new http:Listener(9090) {
    ...
    resource function get data() returns json|error {
        ...
        contact:Client contactEndpoint = check new ({auth: {refreshUrl: "https://api.hubapi.com/oauth/v1/token", refreshToken: "", clientId: "870c8aa3-a0d7-42ec-bc97-b9b7bbaf106c", clientSecret: "fe12cd9a-b33f-4e05-9529-59a1addbedad"}});
